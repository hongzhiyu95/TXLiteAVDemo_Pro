...
+ (void)loginAppServer:(NSString *)userID pwd:(NSString *)pwd roomID:(uint32_t)roomID sdkappid:(uint32_t)sdkappid withCompletion:(ILoginAppCompletion)completion {
    NSDictionary *reqParam = @{@"identifier": userID, @"pwd": pwd, @"appid": @(sdkappid), @"roomnum": @(roomID), @"privMap": @(255), @"accounttype": @(14418)};
    NSString *reqUrl = @"https://service.trtc.qcloud.com/release/UserSigService";
