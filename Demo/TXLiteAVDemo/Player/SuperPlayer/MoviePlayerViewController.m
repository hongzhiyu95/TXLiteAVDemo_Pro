...
- (void)appWillEnterBackGround {
    if (((SPDefaultControlView *)self.playerView.controlView).danmakuBtn.isSelected) {
...
- (void)_refreshLiveList {
    ...
    [manager GET:@"http://xzb.qcloud.com/get_live_list2" parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
