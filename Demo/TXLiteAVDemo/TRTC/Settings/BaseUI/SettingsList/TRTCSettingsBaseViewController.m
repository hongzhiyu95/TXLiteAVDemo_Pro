...
- (void)setupTableView {
    ...
    [self.tableView registerClass:TRTCSettingsSubRoomCellTableViewItem.bindedCellClass
           forCellReuseIdentifier:TRTCSettingsSubRoomCellTableViewItem.bindedCellId];
