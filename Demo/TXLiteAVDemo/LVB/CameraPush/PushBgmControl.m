...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        micVolumeSlider.continuous = NO;
        [micVolumeSlider addTarget:self action:@selector(micVolume:) forControlEvents:UIControlEventValueChanged];
        ...
        bgmPitchSlider.continuous = NO;
        [bgmPitchSlider addTarget:self action:@selector(bgmPitch:) forControlEvents:UIControlEventValueChanged];
