...
typedef void(^readFrameS)(NSMutableArray *sampleBufferList);
...
@interface iLiveMVReader : NSObject
...
- (void) readVideoFrameSFromTime:(float)startTime
                          toTime:(float)endTime
                        interval:(float)interval
                       isReverse:(BOOL)isReverse
                      readFrameS:(readFrameS)readFrameS
                    readFinished:(readFinished)readFinished;
