...
- (void)resetAndApplyValues
{
    ...
    NSDictionary *defaultFilterValue = @{
                                    ...
                                    ,TCFilterIdentifierZiran :@(6)
                                    ,TCFilterIdentifierBaixi :@(8)
...
- (void)_generateMenuItems {
    ...
    NSArray *beautyArray = @[
        ...
        makeMenuItem(L(@"TC.BeautySettingPanel.ThinFace"), _theme.beautyPanelFaceSlimIcon, nil, @selector(setFaceSlimLevel:), -10, 10),
        makeMenuItem(L(@"TC.BeautySettingPanel.VFace"), _theme.beautyPanelFaceVIcon, nil, @selector(setFaceVLevel:), 0, 10),
        makeMenuItem(L(@"TC.BeautySettingPanel.NarrowFace"), _theme.beautyPanelFaceVIcon, nil, @selector(setFaceNarrowLevel:), -10, 10),
        makeMenuItem(L(@"TC.BeautySettingPanel.Chin"), _theme.beautyPanelChinIcon, nil, @selector(setChinLevel:), -10, 10),
        makeMenuItem(L(@"TC.BeautySettingPanel.ShortFace"), _theme.beautyPanelFaceScaleIcon, nil, @selector(setFaceShortLevel:), -10, 10),
