...
public:
    ...
    /**
     * 5.19 标记单聊会话已读（待废弃接口，请使用 CleanConversationUnreadMessageCount 接口）
     * @note 请注意：
    ...
    /**
     * 5.20 标记群组会话已读（待废弃接口，请使用 CleanConversationUnreadMessageCount 接口）
      *  @note 请注意：
      *  - 该接口调用成功后，自己的未读数会清 0。
    ...
    /**
     * 5.21 标记所有会话为已读（待废弃接口，请使用 CleanConversationUnreadMessageCount 接口）
     */
